...
DB_URI = os.environ.get("DATABASE_URL", "mongodb+srv://vicky9:2003@cluster0.nlwkt.mongodb.net/?retryWrites=true&w=majority&appName=Cluster0")
DB_NAME = os.environ.get("DATABASE_NAME", "vicky9")
...
TUT_VID = os.environ.get("TUT_VID", "https://t.me/verify_delight/2")

#force sub channel id, if you want enable force sub
FORCE_SUB_CHANNEL = int(os.environ.get("FORCE_SUB_CHANNEL", "-1002115482280"))
FORCESUB_CHANNEL2 = int(os.environ.get("FORCESUB_CHANNEL2", "-1002084114293"))
